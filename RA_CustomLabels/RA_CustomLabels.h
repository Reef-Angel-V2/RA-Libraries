...
const char EXP_RELAY_2_LABEL[] PROGMEM = "Exp. Relay Box 2";
const char EXP_RELAY_3_LABEL[] PROGMEM = "Exp. Relay Box 3";
const char EXP_RELAY_4_LABEL[] PROGMEM = "Exp. Relay Box 4";
const char EXP_RELAY_5_LABEL[] PROGMEM = "Exp. Relay Box 5";
const char EXP_RELAY_6_LABEL[] PROGMEM = "Exp. Relay Box 6";
const char EXP_RELAY_7_LABEL[] PROGMEM = "Exp. Relay Box 7";
const char EXP_RELAY_8_LABEL[] PROGMEM = "Exp. Relay Box 8";
const char PWM_EXPANSION_LABEL[] PROGMEM = "PWM Expansion";
const char SIXTEENCH_PWM_EXPANSION_LABEL[] PROGMEM = "16 Ch PWM Expansion";
const char RF_EXPANSION_LABEL[] PROGMEM = "RF Expansion";
const char RF_EXPANSION_LABEL1[] PROGMEM = "RF Expansion";
...
const char ALERT_LIGHTS_ON_LABEL[] PROGMEM = "Lights On";
const char ALERT_ATO_TIMEOUT_LABEL[] PROGMEM = "ATO Timeout";
const char ALERT_OVERHEAT_LABEL[] PROGMEM = "Overheat";
const char ALERT_BUSLOCK_LABEL[] PROGMEM = "Bus Lock";
const char ALERT_LEAK_LABEL[] PROGMEM = "Water Leak";
...
const char LABEL_ALARM[] PROGMEM = "Alarm";
const char LABEL_LEAK[] PROGMEM = "Leak";
const char LABEL_DAYLIGHT[] PROGMEM = "Daylight";
const char LABEL_DAYLIGHT2[] PROGMEM = "Daylight 2";
const char LABEL_ACTINIC[] PROGMEM = "Actinic";
...
const char LABEL_CUSTOM_EXP2[] PROGMEM = "Exp 2";
const char LABEL_CUSTOM_EXP3[] PROGMEM = "Exp 3";
const char LABEL_CUSTOM_EXP4[] PROGMEM = "Exp 4";
const char LABEL_CUSTOM_EXP5[] PROGMEM = "Exp 5";
...
const char LABEL_PWME3[] PROGMEM = "Channel 3";
...
const char LABEL_IO3[] PROGMEM = "I/O Channel 3";
const char LABEL_IO4[] PROGMEM = "I/O Channel 4";
const char LABEL_IO5[] PROGMEM = "I/O Channel 5";

const char LABEL_C0[] PROGMEM = "Custom Var 0";
const char LABEL_C1[] PROGMEM = "Custom Var 1";
const char LABEL_C2[] PROGMEM = "Custom Var 2";
const char LABEL_C3[] PROGMEM = "Custom Var 3";
const char LABEL_C4[] PROGMEM = "Custom Var 4";
const char LABEL_C5[] PROGMEM = "Custom Var 5";
const char LABEL_C6[] PROGMEM = "Custom Var 6";
const char LABEL_C7[] PROGMEM = "Custom Var 7";

const char LABEL_PORT1[] PROGMEM = "Port 1";
const char LABEL_PORT2[] PROGMEM = "Port 2";
const char LABEL_PORT3[] PROGMEM = "Port 3";
const char LABEL_PORT4[] PROGMEM = "Port 4";
const char LABEL_PORT5[] PROGMEM = "Port 5";
const char LABEL_PORT6[] PROGMEM = "Port 6";
const char LABEL_PORT7[] PROGMEM = "Port 7";
const char LABEL_PORT8[] PROGMEM = "Port 8";
const char LABEL_PORT11[] PROGMEM = "Port 11";
const char LABEL_PORT12[] PROGMEM = "Port 12";
const char LABEL_PORT13[] PROGMEM = "Port 13";
const char LABEL_PORT14[] PROGMEM = "Port 14";
const char LABEL_PORT15[] PROGMEM = "Port 15";
const char LABEL_PORT16[] PROGMEM = "Port 16";
const char LABEL_PORT17[] PROGMEM = "Port 17";
const char LABEL_PORT18[] PROGMEM = "Port 18";
const char LABEL_PORT21[] PROGMEM = "Port 21";
const char LABEL_PORT22[] PROGMEM = "Port 22";
const char LABEL_PORT23[] PROGMEM = "Port 23";
const char LABEL_PORT24[] PROGMEM = "Port 24";
const char LABEL_PORT25[] PROGMEM = "Port 25";
const char LABEL_PORT26[] PROGMEM = "Port 26";
const char LABEL_PORT27[] PROGMEM = "Port 27";
const char LABEL_PORT28[] PROGMEM = "Port 28";
const char LABEL_PORT31[] PROGMEM = "Port 31";
const char LABEL_PORT32[] PROGMEM = "Port 32";
const char LABEL_PORT33[] PROGMEM = "Port 33";
const char LABEL_PORT34[] PROGMEM = "Port 34";
const char LABEL_PORT35[] PROGMEM = "Port 35";
const char LABEL_PORT36[] PROGMEM = "Port 36";
const char LABEL_PORT37[] PROGMEM = "Port 37";
const char LABEL_PORT38[] PROGMEM = "Port 38";
const char LABEL_PORT41[] PROGMEM = "Port 41";
const char LABEL_PORT42[] PROGMEM = "Port 42";
const char LABEL_PORT43[] PROGMEM = "Port 43";
const char LABEL_PORT44[] PROGMEM = "Port 44";
const char LABEL_PORT45[] PROGMEM = "Port 45";
const char LABEL_PORT46[] PROGMEM = "Port 46";
const char LABEL_PORT47[] PROGMEM = "Port 47";
const char LABEL_PORT48[] PROGMEM = "Port 48";
const char LABEL_PORT51[] PROGMEM = "Port 51";
const char LABEL_PORT52[] PROGMEM = "Port 52";
const char LABEL_PORT53[] PROGMEM = "Port 53";
const char LABEL_PORT54[] PROGMEM = "Port 54";
const char LABEL_PORT55[] PROGMEM = "Port 55";
const char LABEL_PORT56[] PROGMEM = "Port 56";
const char LABEL_PORT57[] PROGMEM = "Port 57";
const char LABEL_PORT58[] PROGMEM = "Port 58";
const char LABEL_PORT61[] PROGMEM = "Port 61";
const char LABEL_PORT62[] PROGMEM = "Port 62";
const char LABEL_PORT63[] PROGMEM = "Port 63";
const char LABEL_PORT64[] PROGMEM = "Port 64";
const char LABEL_PORT65[] PROGMEM = "Port 65";
const char LABEL_PORT66[] PROGMEM = "Port 66";
const char LABEL_PORT67[] PROGMEM = "Port 67";
const char LABEL_PORT68[] PROGMEM = "Port 68";
const char LABEL_PORT71[] PROGMEM = "Port 71";
const char LABEL_PORT72[] PROGMEM = "Port 72";
const char LABEL_PORT73[] PROGMEM = "Port 73";
const char LABEL_PORT74[] PROGMEM = "Port 74";
const char LABEL_PORT75[] PROGMEM = "Port 75";
const char LABEL_PORT76[] PROGMEM = "Port 76";
const char LABEL_PORT77[] PROGMEM = "Port 77";
const char LABEL_PORT78[] PROGMEM = "Port 78";
const char LABEL_PORT81[] PROGMEM = "Port 81";
const char LABEL_PORT82[] PROGMEM = "Port 82";
const char LABEL_PORT83[] PROGMEM = "Port 83";
const char LABEL_PORT84[] PROGMEM = "Port 84";
const char LABEL_PORT85[] PROGMEM = "Port 85";
const char LABEL_PORT86[] PROGMEM = "Port 86";
const char LABEL_PORT87[] PROGMEM = "Port 87";
const char LABEL_PORT88[] PROGMEM = "Port 88";

const char LABEL_AI_WHITE[] PROGMEM = "White";
const char LABEL_AI_BLUE[] PROGMEM = "Blue";
const char LABEL_AI_ROYAL_BLUE[] PROGMEM = "R. Blue";
