 ...
 */
  ...
  */
  ...
  {
	  SetDaylightRaw(Parabola(0,InternalMemory.LEDPWMDaylight_read(),0,PreMinuteOffset,PostMinuteOffset));
  }
  ...
  {
	  SetDaylight2Raw(SmoothRamp(InternalMemory.PWMSlopeStartD2_read(),InternalMemory.PWMSlopeEndD2_read(),InternalMemory.PWMSlopeDurationD2_read(),Daylight2PWMValue,PreMinuteOffset,PostMinuteOffset));
  }
  ...
  {
	  SetDaylight2Raw(Parabola(0,InternalMemory.LEDPWMDaylight2_read(),0,PreMinuteOffset,PostMinuteOffset));
  }
